...
#+BEGIN_SRC emacs-lisp
  ...
  If I let Windows handle DPI everything looks blurry."
    ...
    (when (eq gds/monitor-width-mm '334) ;; MacbookPro -> external Dell
      (setq gds/monitor 'Dell)
      (setq gds/font-size 95))
    ...
    ;;        (gds/monitor 'Default)
    ;;        (gds/font-size 13)) ;; default for first screen at work
    ;;   (when (eq gds/monitor-attr-mm-size (594 334)) ;; MacbookPro -> external Dell
    ;;     (setq gds/monitor 'Dell)
    ;;     (setq gds/font-size 16))
      ;; (when (eq width-mm 285) ;; MacbookPro -> Retina
      ;;   (setq gds/monitor 'Retina)
      ;;   (setq gds/font-size 16))
      ;; (when (eq width-mm 508) ;; MacbookPro -> external Dell -> RDC -> Windows -> emacs
      ;;   (setq gds/monitor 'RDC)
      ;;   (setq gds/font-size 16))
